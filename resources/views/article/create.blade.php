                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input type="text" form="createArticle"
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="file" accept="image/jpeg,iamge/png" form="createArticle"
                        ...
                        <button form="createArticle" class=" btn btn-primary">Save Article</button>
